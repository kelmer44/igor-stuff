...
- `igor-cd/IGOR.EXE` — 289 catalogued resources (including the 13 recovered
  outside-administration resources) plus all 30 additional structurally
  discovered room chains (119 IMG/PAL/MSK/BOX regions).
...
known regions inside room action blobs, and byte-indexed walk-line tables. Other
room-specific sprite and DAT data remain named raw blobs where their internal format
